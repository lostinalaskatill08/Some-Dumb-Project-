...
interface Step5SalesOutreachProps {
...
const Step5SalesOutreach: React.FC<Step5SalesOutreachProps> = ({ result, loading, error }) => {
  return (
    <div className="space-y-6 animate-fade-in">
      <div>
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-white">Outline Outreach Strategy</h2>
        <p className="mt-2 text-gray-600 dark:text-gray-400">
          The AI is now generating recommended lead generation channels and a competitor snapshot.
        </p>
      </div>
      ...
      <div className="p-6 bg-gray-50 dark:bg-gray-900/50 rounded-xl border border-gray-200 dark:border-gray-700 min-h-[400px]">
        {loading ? (
            <div className="flex flex-col justify-center items-center h-full text-center">
                ...
                <p className="text-lg font-semibold text-gray-700 dark:text-gray-300">Developing Outreach Plan...</p>
...
export default Step5SalesOutreach;
