...
interface Step4SalesSellingPointsProps {
...
const Step4SalesSellingPoints: React.FC<Step4SalesSellingPointsProps> = ({ result, loading, error }) => {
  return (
    <div className="space-y-6 animate-fade-in">
      <div>
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-white">Identify Key Selling Points</h2>
        <p className="mt-2 text-gray-600 dark:text-gray-400">
          Based on your target market, the AI is now crafting compelling marketing messages and sales hooks.
        </p>
      </div>
      ...
      <div className="p-6 bg-gray-50 dark:bg-gray-900/50 rounded-xl border border-gray-200 dark:border-gray-700 min-h-[400px]">
        {loading ? (
            <div className="flex flex-col justify-center items-center h-full text-center">
                ...
                <p className="text-lg font-semibold text-gray-700 dark:text-gray-300">Generating Marketing Messages...</p>
...
export default Step4SalesSellingPoints;
