...
interface Step2SalesTechnologyProps {
  formData: FormData;
...
const Step2SalesTechnology: React.FC<Step2SalesTechnologyProps> = ({ formData, onDataChange }) => {

  return (
    <div className="space-y-8 animate-fade-in">
      <div>
        <h2 className="text-2xl font-semibold text-slate-800 dark:text-white">Technology Selection</h2>
        <p className="mt-2 text-slate-600 dark:text-slate-400">Select the primary green energy technology you are selling or consulting for in <strong>{formData.location}</strong> to begin the analysis.</p>
      </div>
...
export default Step2SalesTechnology;
